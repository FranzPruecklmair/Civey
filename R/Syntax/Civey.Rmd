...
plot1 <- ggplot(bias, aes(x=Selektion,y=CDU,fill = Selektion)) + geom_boxplot( show.legend = FALSE)+ scale_fill_brewer(palette="Blues")+ geom_hline(yintercept = 0,color = "red")
plot2 <- ggplot(bias, aes(x=Selektion,y=SPD,fill = Selektion)) + geom_boxplot( show.legend = FALSE)+ scale_fill_brewer(palette="Blues") + geom_hline(yintercept = 0,color = "red")
plot3 <- ggplot(bias, aes(x=Selektion,y=Linke,fill = Selektion)) + geom_boxplot( show.legend = FALSE)+ scale_fill_brewer(palette="Blues") + geom_hline(yintercept = 0,color = "red")
plot4 <- ggplot(bias, aes(x=Selektion,y=Grüne,fill = Selektion)) + geom_boxplot( show.legend = FALSE)+ scale_fill_brewer(palette="Blues") + geom_hline(yintercept = 0,color = "red")
plot5 <- ggplot(bias, aes(x=Selektion,y=FDP,fill = Selektion)) + geom_boxplot( show.legend = FALSE)+ scale_fill_brewer(palette="Blues") + geom_hline(yintercept = 0,color = "red")
plot6 <- ggplot(bias, aes(x=Selektion,y=AFD,fill = Selektion)) + geom_boxplot(show.legend = FALSE)+ scale_fill_brewer(palette="Blues") + geom_hline(yintercept = 0,color = "red")
...
g <- cbind(rbind(g1, g2, g3), rbind(g4, g5, g6))
grid.newpage()
grid.draw(g)
