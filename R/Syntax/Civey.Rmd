...
stargazer(impact_internet,impact_blogger,impact_interpol,
          ...
          out = "Z:/Zwischenergebnisse/Wahlentscheidung/SAR- Annahme/SAR-Wahleintscheidung.html",
          dep.var.labels = c("Internet","Blogger","Interpol"),
          covariate.labels = c("Männlich (Ja)","Alter<20","20-40","60-70","Alter>70","40-60","Bildung niedrig","Mitte",
                               "Bildung hoch","Verheiratet (Ja)", "Großstadt", "Stadt", "Dorf","SPD vs. Union","Linke vs. Union",
                               "Grüne vs. Union","FDP vs. Union","AFD vs. Union","(Intercept)" ))
