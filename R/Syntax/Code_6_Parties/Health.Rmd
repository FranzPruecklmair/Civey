...
xnam_gesundheit <- paste("male + age_le_20 + age_20_40  + age_60_70 + age_gt_70  +
  edu1 + edu2  + married + city + town  + parteinähe + gesundheit")
...
# summary(impact_blogger)#MAR afd hat signifikannten Einfluss
...
#           out = "Z:/Zwischenergebnisse/Gesundheit/SAR- Annahme/SAR-Wahleintscheidung.txt",
...
write.csv2(internet_tabelle, file = "Z:/Zwischenergebnisse/Gesundheit/Tabellen/internet_tabelle.csv", quote = FALSE, row.names = T)
write.csv2(blogger_tabelle, file = "Z:/Zwischenergebnisse/Gesundheit/Tabellen/blogger_tabelle.csv", quote = FALSE, row.names = T)
write.csv2(interpol_tabelle, file = "Z:/Zwischenergebnisse/Gesundheit/Tabellen/interpol_tabelle.csv", quote = FALSE, row.names = T)
