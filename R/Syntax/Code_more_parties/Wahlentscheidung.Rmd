...
summary(impact_interpol)# Alle Parteien bis auf Sonstige wirken sich aus
...
plot2 <- plotter(bias,bias$Selektion,bias$CDU,verz,verz$Selektion2,verz$CDU2,ESSBias[3],"SPD")
