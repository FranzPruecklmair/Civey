...
wahl <- c(round((c( 33, 20.5, 9.2, 8.9, 10.7, 12.6, 5)*76.2/summ),1),23.8)
...
germany_18$partei <- factor(germany_18$partei, levels = c("Union","SPD","Linke","Grünen","FDP","AFD","Sonstige","Nichtwähler"))
...
df2 <- data.frame(data=rep(c( "Wahl2017","ESS2018"), each=8),
                  part=rep(c("Union","SPD","Linke","Grünen","FDP","AFD","Sonstige", "Nichtwähler"),2),
                  percent=(c(wahl,ESS)))
df2 $part = factor(df2$part, levels = c("Union","SPD","Linke","Grünen","FDP","AFD","Sonstige", "Nichtwähler"))
...
names(bias) <- c("CDU","SPD","Linke","Grüne","FDP","AFD","Sonstige","Nichtwaehler","Selektion")
...
names(verz) <- c("CDU2","SPD2","Linke2","Grüne2","FDP2","AFD2","Sonstige2","Nichtwaehler2","Selektion2")
...
plot8 <- plotter(bias,bias$Selektion,bias$Nichtwaehler,verz,verz$Selektion2,verz$Nichtwaehler2,"Nichtwaehler")
...
names(bias.rak) <- c("CDU","SPD","Linke","Grüne","FDP","AFD","Sonstige","Nichtwaehler","Selektion")
...
plot8.rak <- plotter(bias.rak,bias.rak$Selektion,bias.rak$Nichtwaehler,verz,verz$Selektion2,verz$Nichtwaehler2,"Nichtwaehler")
