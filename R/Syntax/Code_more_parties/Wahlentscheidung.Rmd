...
germany_18$partei <- factor(germany_18$partei, levels = c("Sonstige","Union","SPD","Linke","Grünen","FDP","AFD"))
...
summary(aov(formula =impact_internet ))
summary(aov(formula =impact_blogger ))
summary(aov(formula =impact_interpol ))
