...
xnam_lire <- paste("male + age_le_20 + age_20_40 + age_60_70 + age_gt_70 +
                               edu1 + edu2  + married + city + town + partei  + lire")
...
summary(impact_blogger)#nichtSAR
summary(impact_interpol)#nichtSAR
...
stargazer(impact_internet,impact_blogger,impact_interpol,
          ...
          out = "Z:/Zwischenergebnisse_Nichtwahl/Extreme Einstellung/SAR- Annahme/SAR-Extreme-Einstellung.txt",
          ...
          covariate.labels = c("Männlich (Ja)","Alter<20 vs.40-60","20-40 vs.40-60","60-70 vs.40-60","Alter>70 vs.40-60",
                               ...
                               "Großstadt vs. Dorf",
                               "Stadt vs. Dorf","Union vs. Nichtwähler",
...
write.csv2(internet_tabelle, file = "Z:/Zwischenergebnisse_Nichtwahl/Extreme Einstellung/Tabellen/internet_tabelle.csv", quote = FALSE, row.names = T)
write.csv2(blogger_tabelle, file = "Z:/Zwischenergebnisse_Nichtwahl/Extreme Einstellung/Tabellen/blogger_tabelle.csv", quote = FALSE, row.names = T)
write.csv2(interpol_tabelle, file = "Z:/Zwischenergebnisse_Nichtwahl/Extreme Einstellung/Tabellen/interpol_tabelle.csv", quote = FALSE, row.names = T)
