...
xnam_Zufr <- paste("male + age_le_20 + age_20_40  + age_60_70 + age_gt_70  +
  edu1 + edu2 + married + city + town  + partei + Zufr")
...
summary(impact_internet)# nicht SAR
...
stargazer(impact_internet,impact_blogger,impact_interpol,
          ...
          out = "Z:/Zwischenergebnisse_Nichtwahl/Lebenszufriedenheit/SAR- Annahme/Lebenszufriedenheit.txt",
...
write.csv2(internet_tabelle, file = "Z:/Zwischenergebnisse_Nichtwahl/Lebenszufriedenheit/Tabellen/internet_tabelle.csv", quote = FALSE, row.names = T)
write.csv2(blogger_tabelle, file = "Z:/Zwischenergebnisse_Nichtwahl/Lebenszufriedenheit/Tabellen/blogger_tabelle.csv", quote = FALSE, row.names = T)
write.csv2(interpol_tabelle, file = "Z:/Zwischenergebnisse_Nichtwahl/Lebenszufriedenheit/Tabellen/interpol_tabelle.csv", quote = FALSE, row.names = T)
