...
# Teildatensätze --------------------------------------------------------------
ONLINE      <- subset(ESS9DE,online == T )
INTERNET_3h <- subset(ESS9DE,internet_3h == T )
INTERNET_4h <- subset(ESS9DE,internet_4h == T )
INTERNET_5h <- subset(ESS9DE,internet_5h== T )
...
onl <- design.table(ONLINE,~pspwght,~prtvede2)
int_3h <- design.table(INTERNET_3h,~pspwght,~prtvede2)
int_4h <- design.table(INTERNET_4h,~pspwght,~prtvede2)
int_5h <- design.table(INTERNET_5h,~pspwght,~prtvede2)
...
rbind(psp,onl,meanonline.cor,meanonline.rak)
rbind(psp,int_3h,meaninternet_3h.cor,meaninternet_3h.rak)
rbind(psp,int_4h,meaninternet_4h.cor,meaninternet_4h.rak)
rbind(psp,int_5h,meaninternet_5h.cor,meaninternet_5h.rak)
```
