...
xnam_umwelt <- paste("male + age_le_20 + age_20_40  + age_60_70 + age_gt_70 +
  edu1 + edu2  + married + city + town + parteinähe + umwelt")
...
stargazer(impact_internet,impact_blogger,impact_interpol,
          ...
          out = "Z:/Zwischenergebnisse/Umwelt/SAR- Annahme/SAR-Umwelt.html",
...
write.csv2(internet_tabelle, file = "Z:/Zwischenergebnisse/Umwelt/Tabellen/internet_tabelle.csv", quote = FALSE, row.names = T)
write.csv2(blogger_tabelle, file = "Z:/Zwischenergebnisse/Umwelt/Tabellen/blogger_tabelle.csv", quote = FALSE, row.names = T)
write.csv2(interpol_tabelle, file = "Z:/Zwischenergebnisse/Umwelt/Tabellen/interpol_tabelle.csv", quote = FALSE, row.names = T)
