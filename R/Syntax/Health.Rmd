...
psp <- design.table(ESS9DE,~pspwght,~health)
int <- design.table(INTERNET,~pspwght,~health)
blog <- design.table(BLOGGER,~pspwght,~health)
inpol <- design.table(INTERPOL,~pspwght,~health)
