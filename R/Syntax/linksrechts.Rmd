...
xnam_lire <- paste("male + age_le_20 + age_20_40  + age_60_70 + age_gt_70 + age_40_60 +
  edu1 + edu2 + edu3 + married + city + town + village + parteinähe + lire")
...
plot1 <- plotter(bias,bias$Selektion,bias$Rechts,verz,verz$Selektion2,verz$Rechts2,"Rechts")
plot2 <- plotter(bias,bias$Selektion,bias$Mitte,verz,verz$Selektion2,verz$Mitte2,"Mitte")
plot3 <- plotter(bias,bias$Selektion,bias$Links,verz,verz$Selektion2,verz$Links2,"Links")




grid.arrange(plot1, plot2, plot3, nrow = 1, ncol = 3, top = textGrob("Pseudogewichtete Parteipräferenz",gp=gpar(fontsize=20,font=1)))
...
plot1.rak <- plotter(bias.rak,bias.rak$Selektion,bias.rak$Rechts,verz,verz$Selektion2,verz$Rechts2,"Rechts")
plot2.rak <- plotter(bias.rak,bias.rak$Selektion,bias.rak$Mitte,verz,verz$Selektion2,verz$Mitte2,"Mitte")
plot3.rak <- plotter(bias.rak,bias.rak$Selektion,bias.rak$Links,verz,verz$Selektion2,verz$Links2,"Links")

grid.arrange(plot1.rak, plot2.rak, plot3.rak, nrow = 1, ncol = 3, top = textGrob("Calibrierte Parteipräferenz",gp=gpar(fontsize=20,font=1)))
